...
#
define(`_async',`dnl
dnl### Start of connector async definition
...
pushdef(`__prefixX',_NAME(,_context,Xasync,V`'_varname))dnl
dnl
dnl##### Start of role sender definitions
dnl
dnl #
dnl # Name of role#1
dnl #
define(_NAME(__prefixX,RlNm1),`sender')dnl
dnl
dnl #
...
dnl##### Start of role sender, port sending, action _ definitions
dnl # Connector,Role,Port
dnl #
dnl # Name of port#1
dnl #
define(_NAME(__prefixR,PrtNm1),`sending')dnl
dnl #
...
define(_NAME(__prefixRP,kind),`emitter')dnl
dnl #
...
dnl##### End of role sender, port sending, action _ definitions
`'dnl
popdef(`__prefixRType')dnl
popdef(`__prefixR')dnl
dnl##### End of role sender definitions
dnl
dnl##### Start of role recipient definitions
dnl
dnl #
dnl # Name of role#2
dnl #
define(_NAME(__prefixX,RlNm2),`recipient')dnl
dnl
dnl #
...
dnl #
define(_NAME(__prefixR,inits),)dnl
dnl##### Start of role recipient, port receiving, action _ definitions
dnl # Connector,Role,Port
dnl #
dnl # Name of port#1
dnl #
define(_NAME(__prefixR,PrtNm1),`receiving')dnl
dnl #
dnl # Prefix of port#1
dnl #
pushdef(`__prefixRP',_NAME(__prefixR,Prt1))dnl
...
define(_NAME(__prefixRP,sizeExpr),`1')dnl
define(_NAME(__prefixRP,size),`1')dnl
define(_NAME(__prefixRP,kind),`consumer')dnl
dnl #
dnl # Size checker of port#1
dnl #
define(_NAME(__prefixRP,checkSize),`dnl
...
dnl popdef(`__prefixRPA')dnl
dnl popdef(`__prefixRP')dnl
dnl##### End of role recipient, port receiving, action _ definitions
`'dnl
popdef(`__prefixRType')dnl
popdef(`__prefixR')dnl
dnl##### End of role recipient definitions
`'dnl
popdef(`__prefixX')dnl
popdef(`_params')dnl
popdef(`_varname')dnl
popdef(`_context')dnl
dnl### End of connector async definition
')dnl
divert(0)dnl
dnl Debugging
dnl _async(a,b)
